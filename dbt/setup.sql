...
GRANT ROLE DBT_ROLE TO USER SERVICE;
...
-- If running from project root: PUT file://./dbt/seeds/filename.json @STAGE.RAW_DATA_STAGE;
-- If running from dbt directory: PUT file://./seeds/filename.json @STAGE.RAW_DATA_STAGE;
